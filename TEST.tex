...
\newcommand{\outheader}{
	\color{purple}\bfseries	VẬT LÝ 12 - CHƯƠNG TRÌNH MỚI
}
\newcommand{\namhoc}{
...
\begin{document}
	...
	\begin{tabular}{C{7.5cm}C{9.5cm}}
		\textbf{VẬT LÝ CÔ THẢO - THẦY SANG}& \textbf{KIỂM TRA CUỐI CHƯƠNG 1} \\
		\textbf{ĐỀ PH12C01}& \textbf{Môn: VẬT LÝ}\\
